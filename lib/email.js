...
async function sendEmail({ to, subject, html, text }) {
  ...
  // 1. Try Brevo REST API v3 (Recommended — works without domain validation or local SMTP restrictions)
  if (brevoApiKey) {
    try {
  ...
  return { success: false, error: 'No working email service credentials configured or all providers failed.' };
}
